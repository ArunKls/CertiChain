...
async function sendTransaction(operator, sender, receiver) {
  ...
  let accBalSenderQuery = new AccountBalanceQuery().setAccountId(senderDetails.accountId);
  ...
  let accBalReceiverQuery = new AccountBalanceQuery().setAccountId(receiverDetails.accountId);
